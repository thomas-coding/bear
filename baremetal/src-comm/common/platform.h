...
#define SYSREG2_IDAU_CTRL (SYSREG2_BASE + 0x160)
#define SYSREG2_SRAM_SEC_SIZE1 (SYSREG2_BASE + 0x164)
#define SYSREG2_SRAM_SEC_SIZE2 (SYSREG2_BASE + 0x168)
#define SYSREG2_FLASH_SEC_SIZE1 (SYSREG2_BASE + 0x16c)
#define SYSREG2_FLASH_SEC_SIZE2 (SYSREG2_BASE + 0x170)
